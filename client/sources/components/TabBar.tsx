...
export type TabType = 'zen' | 'chats' | 'boxes' | 'me';
...
export const TabBar = React.memo(({ activeTab, onTabPress }: TabBarProps) => {
    ...
    const tabs: { key: TabType; icon: any; label: string }[] = React.useMemo(() => {
        ...
        // Add regular tabs
        baseTabs.push(
            { key: 'chats', icon: require('@/assets/images/brutalist/Brutalism 15.png'), label: t('tabs.chats') },
            { key: 'boxes', icon: require('@/assets/images/brutalist/Brutalism 27.png'), label: t('tabs.boxes') },
            { key: 'me', icon: require('@/assets/images/brutalist/Brutalism 9.png'), label: t('tabs.me') },
        );
